 ...
 */
public class teletest2half extends OpMode  {
    ...
    public void loop()  {
        ...
        motor1.setPower((throttleLeft*-1)/2.5);
        motor2.setPower((throttleLeft*-1)/2.5);
        motor3.setPower((throttleRight)/2.5);
        motor4.setPower((throttleRight)/2.5);
