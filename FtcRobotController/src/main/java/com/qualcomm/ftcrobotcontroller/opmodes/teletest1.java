 ...
 */
public class teletest1 extends OpMode  {
    ...
    public void loop()  {
        ...
        motor1.setPower((throttleLeft)/2);
        motor2.setPower((throttleLeft*-1)/2);
        motor3.setPower((throttleRight)/2);
        motor4.setPower((throttleRight*-1)/2);
